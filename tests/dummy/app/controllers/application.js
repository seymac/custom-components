...
export default Ember.Controller.extend({
  ...
  anotherData: Ember.A( [ Ember.Object.create({ id: 1, title: 'A'}), 
  							Ember.Object.create({ id: 2, title: 'B'}),
  							Ember.Object.create({ id: 3, title: 'C'}),
  							Ember.Object.create({ id: 4, title: 'D'}),
